# env-lock Publish Guide
# ======================
# Follow these steps to publish env-lock to npm and GitHub
...
# In your terminal, navigate to the env-lock project folder:
cd /path/to/env-lock
...
- env-lock run command for secure execution
- env-lock doctor health checks
...
git remote add origin https://github.com/YOUR_USERNAME/env-lock.git
...
# 1. Visit https://www.npmjs.com/package/env-lock
...
# 1. Go to https://github.com/YOUR_USERNAME/env-lock/releases/new
# 2. Choose tag: v1.0.0
# 3. Title: env-lock v1.0.0
...
# Go to https://github.com/YOUR_USERNAME/env-lock/actions
...
npm deprecate env-lock@1.0.0 "Critical security fix in v1.0.1"
